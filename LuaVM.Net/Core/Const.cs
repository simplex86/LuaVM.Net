...
namespace LuaVM.Net.Core
{
    ...
    internal static class OperationCodes
    {
        ...
        private static readonly OperationCode[] codes = new OperationCode[] {
            ...
            new OperationCode(0, 1, OperationArgs.U, OperationArgs.U, InstructionMode.IABC,  "CALL    ", VM.Call),
            new OperationCode(0, 1, OperationArgs.U, OperationArgs.U, InstructionMode.IABC,  "TAILCALL", VM.TailCall),
            new OperationCode(0, 0, OperationArgs.U, OperationArgs.N, InstructionMode.IABC,  "RETURN  ", VM.Return),
            ...
            new OperationCode(0, 1, OperationArgs.U, OperationArgs.N, InstructionMode.IABx,  "CLOSURE ", VM.Closure),
            new OperationCode(0, 1, OperationArgs.U, OperationArgs.N, InstructionMode.IABC,  "VARARG  ", VM.Vararg),
