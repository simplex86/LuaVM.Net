...
namespace LuaVM.Net.Core
{
    ...
    internal static class OperationCodes
    {
        ...
        private static readonly OperationCode[] codes = new OperationCode[] {
            ...
            new OperationCode(0, 1, OperationArgs.R, OperationArgs.K, InstructionMode.IABC,  "GETTABLE", VM.Func),
            ...
            new OperationCode(0, 0, OperationArgs.K, OperationArgs.K, InstructionMode.IABC,  "SETTABLE", VM.Func),
            new OperationCode(0, 1, OperationArgs.U, OperationArgs.U, InstructionMode.IABC,  "NEWTABLE", VM.Func),
            ...
            new OperationCode(0, 0, OperationArgs.U, OperationArgs.U, InstructionMode.IABC,  "SETLIST ", VM.Func),
